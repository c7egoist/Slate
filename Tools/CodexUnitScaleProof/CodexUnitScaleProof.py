...
OWNED = [
    "Tools/CodexUnitScaleProof/CodexUnitScaleProof.cpp",
...
def Compile(Source, Strict, Objects):
    Object = ROOT / "Tools" / "CodexUnitScaleProof" / (pathlib.Path(Source).stem + ".o")
...
def Main():
    ...
    Binary = ROOT / "Tools" / "CodexUnitScaleProof" / "CodexUnitScaleProof"
