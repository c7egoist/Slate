#!/usr/bin/env python3
"""Builds and runs the world-draft sketch-bridge proof."""
...
OWNED = [
    "Tools/WorldDraftSketchBridgeProof/WorldDraftSketchBridgeProof.cpp",
    ...
    "Engine/SlateWorkspace/Discipline/WorldDraftInteraction/Source/WorldDraftInteraction.cpp",
    "Engine/SlateWorkspace/Discipline/WorldDraftTransformSession/Source/WorldDraftTransformSession.cpp",
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldDraftSketchBridgeProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldDraftSketchBridgeProof" / "WorldDraftSketchBridgeProof"
