#!/usr/bin/env python3
"""Builds and runs the world-draft rendering proof."""
...
OWNED = [
    "Tools/WorldDraftRenderProof/WorldDraftRenderProof.cpp",
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldDraftRenderProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldDraftRenderProof" / "WorldDraftRenderProof"
