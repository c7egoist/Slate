#!/usr/bin/env python3
"""Builds and runs the world-draft picking proof."""
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldDraftPickingProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldDraftPickingProof" / "WorldDraftPickingProof"
