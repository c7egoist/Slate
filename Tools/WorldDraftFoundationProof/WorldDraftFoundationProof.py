#!/usr/bin/env python3
"""Builds and runs the world-draft foundation proof.
...
OWNED = [
    "Tools/WorldDraftFoundationProof/WorldDraftFoundationProof.cpp",
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldDraftFoundationProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldDraftFoundationProof" / "WorldDraftFoundationProof"
