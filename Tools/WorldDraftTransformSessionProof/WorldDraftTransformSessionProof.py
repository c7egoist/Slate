#!/usr/bin/env python3
"""Builds and runs the world-draft transform-session proof."""
...
OWNED = [
    "Tools/WorldDraftTransformSessionProof/WorldDraftTransformSessionProof.cpp",
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldDraftTransformSessionProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldDraftTransformSessionProof" / "WorldDraftTransformSessionProof"
