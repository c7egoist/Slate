#!/usr/bin/env python3
"""Builds and runs the workplane-catalogue proof.
...
OWNED = [
    "Tools/WorkplaneCatalogueProof/WorkplaneCatalogueProof.cpp",
...
def Compile(Source, Strict, Objects):
    Object = ROOT / "Tools" / "WorkplaneCatalogueProof" / (pathlib.Path(Source).stem + ".o")
...
def Main():
    ...
    Binary = ROOT / "Tools" / "WorkplaneCatalogueProof" / "WorkplaneCatalogueProof"
