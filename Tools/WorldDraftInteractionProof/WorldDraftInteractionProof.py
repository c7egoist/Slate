#!/usr/bin/env python3
"""Builds and runs the world-draft interaction proof."""
...
OWNED = [
    "Tools/WorldDraftInteractionProof/WorldDraftInteractionProof.cpp",
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldDraftInteractionProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldDraftInteractionProof" / "WorldDraftInteractionProof"
