// 🧩 Phase-6 proof for host-style selection and transform flow on the world draft.
...
struct Bench
{
    ...
    {
        DriveWorldDraftSelectionAndTransform(Extent, Pointer, Text,
                                             Selection, Gizmo, Camera,
                                             Draft, SemanticSelection, HoveredSelection,
...
void ProveMouseDragAndReleaseCommit()
{
    ...
    RefreshWorldDraftPick(Stage.Draft, Stage.SemanticSelection);
...
void ProveKeyboardRestrictionAndNumeric()
{
    ...
    ResolveWorldLoopPivot(Stage.Draft, Stage.Loop, Whole.Position);
...
void ProveCurveSlideGesture()
{
    ...
    ResolveWorldCurvePivot(Draft, Diagonal, Semantic.Position);
    WorldPick Hovered = {};
    WorldDraftTransformSession Transform = {};
    double LastG = 1000.0;
    bool PointerTaken = false;
    ...
    Start.Intake[1] = '\0';
    Start.IntakeCount = 1u;
    DriveWorldDraftSelectionAndTransform(Extent, Pointer, Start,
                                         Selection, Gizmo, Camera,
                                         Draft, Semantic, Hovered, Transform,
    ...
    const SpatialDirection Slide = ResolveWorldCurveSlideDirection(Draft, Diagonal, Semantic.Position);
    float EndX = 0.0f;
    float EndY = 0.0f;
    ...
    PointerTaken = false;
    DriveWorldDraftSelectionAndTransform(Extent, Pointer, {},
                                         Selection, Gizmo, Camera,
                                         Draft, Semantic, Hovered, Transform,
...
{
    std::printf("=========================================================================\n");
    std::printf("WORLD DRAFT INTERACTION PROOF\n");
    std::printf("=========================================================================\n");
