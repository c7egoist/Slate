#!/usr/bin/env python3
"""Builds and runs the world-draft editing proof."""
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldDraftEditingProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldDraftEditingProof" / "WorldDraftEditingProof"
