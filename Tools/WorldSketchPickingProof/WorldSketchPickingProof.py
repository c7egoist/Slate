#!/usr/bin/env python3
"""Builds and runs the world-sketch picking proof."""
...
OWNED = [
    "Tools/WorldSketchPickingProof/WorldSketchPickingProof.cpp",
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldSketchPickingProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldSketchPickingProof" / "WorldSketchPickingProof"
