#!/usr/bin/env python3
"""Builds and runs the world-sketch editing proof."""
...
OWNED = [
    "Tools/WorldSketchEditingProof/WorldSketchEditingProof.cpp",
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldSketchEditingProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldSketchEditingProof" / "WorldSketchEditingProof"
