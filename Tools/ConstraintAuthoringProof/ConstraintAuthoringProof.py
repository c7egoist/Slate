#!/usr/bin/env python3
"""Builds and runs the constraint-authoring proof.
...
OWNED = [
    "Tools/ConstraintAuthoringProof/ConstraintAuthoringProof.cpp",
...
def Compile(Source, Strict, Objects):
    Object = ROOT / "Tools" / "ConstraintAuthoringProof" / (pathlib.Path(Source).stem + ".o")
...
def Main():
    ...
    Binary = ROOT / "Tools" / "ConstraintAuthoringProof" / "ConstraintAuthoringProof"
