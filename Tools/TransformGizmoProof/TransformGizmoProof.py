#!/usr/bin/env python3
"""Builds and runs the transform-gizmo proof.
...
OWNED = [
    "Tools/TransformGizmoProof/TransformGizmoProof.cpp",
...
def Compile(Source, Strict, Objects):
    Object = ROOT / "Tools" / "TransformGizmoProof" / (pathlib.Path(Source).stem + ".o")
...
def Main():
    ...
    Binary = ROOT / "Tools" / "TransformGizmoProof" / "TransformGizmoProof"
