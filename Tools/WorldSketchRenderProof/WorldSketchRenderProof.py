#!/usr/bin/env python3
"""Builds and runs the world-sketch rendering proof."""
...
OWNED = [
    "Tools/WorldSketchRenderProof/WorldSketchRenderProof.cpp",
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldSketchRenderProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldSketchRenderProof" / "WorldSketchRenderProof"
