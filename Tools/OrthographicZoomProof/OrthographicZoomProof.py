#!/usr/bin/env python3
"""Builds and runs the orthographic-zoom proof.
...
def Compile(Source, Strict, Objects):
    Object = ROOT / "Tools" / "OrthographicZoomProof" / (pathlib.Path(Source).stem + ".o")
...
def Main():
    ...
    Binary = ROOT / "Tools" / "OrthographicZoomProof" / "OrthographicZoomProof"
