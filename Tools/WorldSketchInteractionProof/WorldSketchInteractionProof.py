#!/usr/bin/env python3
"""Builds and runs the world-sketch interaction proof."""
...
OWNED = [
    "Tools/WorldSketchInteractionProof/WorldSketchInteractionProof.cpp",
...
def compile_source(source: str, strict: bool, objects: list[str]) -> bool:
    obj = ROOT / "Tools" / "WorldSketchInteractionProof" / (pathlib.Path(source).stem + ".o")
...
def main() -> int:
    ...
    binary = ROOT / "Tools" / "WorldSketchInteractionProof" / "WorldSketchInteractionProof"
