...
public:
    ...
    /// out   Result    [-]  refuses with HostDenied when a stroke is already open, with ContentUnsupported for
    ...
    /// out   Result    [-]  refuses with HostDenied before Open and for a speculative stroke, with
