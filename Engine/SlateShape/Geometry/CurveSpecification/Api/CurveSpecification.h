...
//============================================================================================================================================
// 🧩 Exact curve declarations for the CAD kernel — points, directions, parameter intervals, and the closed set
//    of supported curve subjects. These declarations do not own document rows, GPU spans, or editor state.
