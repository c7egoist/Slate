...
namespace
{
    ...
    bool ResolveLoopOutline(const WorldDraftStructure& Declared,
                                                            ...
                                                            double CoplanarTolerance)
{
    ...
    const WorldDraftAnalysis Analysis = AnalyzeWorldDraft(Declared, StepFloor,
